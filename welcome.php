<div
<?php 
    include $_SERVER['DOCUMENT_ROOT'].'/LibrarySys/classes/Book.php';
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-primary btn-sm editButton" data-toggle="modal" data-target="#updateBook" id="<?php echo $book['bookid'];?>"><i class="fa-solid fa-pen-to-square"></i> Edit Book</button>
                                        <button class="btn btn-danger btn-sm deleteButton"data-toggle="modal" data-target="#deleteBook" id="<?php echo $book['bookid'];?>"><i class="fa-solid fa-trash"></i> Delete Book</button>
                                    </td>
                                </tr>
                            <?php endforeach; 
                            endif; ?>
